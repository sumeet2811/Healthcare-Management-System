...
DELIMITER $$
USE `hospital`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `book_appointment`(in id varchar(5), in doc_id varchar(5), in appt_date date)
BEGIN
...
call book_appointment('P103','D1001', '2024-05-15');
